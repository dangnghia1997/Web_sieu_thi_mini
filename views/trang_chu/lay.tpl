...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="smarty/public/css/bootstrap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="smarty/public/css/font-awesome.min.css">
	<link rel="stylesheet" href="smarty/public/css/animate.css">
	<link href="smarty/public/css/animate.min.css" rel="stylesheet"> 
	<link href="smarty/public/css/style.css" rel="stylesheet" />	
    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
    <script src="smarty/public/https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="smarty/public/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>	
	<header id="header">
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">						
						<img src="smarty/public/img/2.jpg" class="img-responsive" alt=""> 
	...
	<section class="action">
		<div class="container">
			...
			<div class="right-image hidden-xs"><img src="smarty/public/img/7.jpg" alt=""></div>
		</div>
	</section>
	...
	<div class="gallery">
		...
		<div class="container">		
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="smarty/public/img/9.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>sweet marley</h4>
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="smarty/public/img/10.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
		...
		<div class="container">
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="smarty/public/img/11.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="smarty/public/img/12.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="smarty/public/img/13.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">				
				<div class="text-center">
					...
					<ul class="sidebar-gallery">
						<li><a href="#"><img src="smarty/public/img/gallery1.png" alt="" /></a></li>
						<li><a href="#"><img src="smarty/public/img/gallery2.png" alt="" /></a></li>
						<li><a href="#"><img src="smarty/public/img/gallery3.png" alt="" /></a></li>
						<li><a href="#"><img src="smarty/public/img/gallery4.png" alt="" /></a></li>
						<li><a href="#"><img src="smarty/public/img/gallery5.png" alt="" /></a></li>
						<li><a href="#"><img src="smarty/public/img/gallery6.png" alt="" /></a></li>					
					</ul>
				</div>
			</div>
    ...
    <script src="smarty/public/js/jquery.js"></script>		
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="smarty/public/js/bootstrap.min.js"></script>	
	<script src="smarty/public/js/wow.min.js"></script>
	<script>
	wow = new WOW(
	 {
